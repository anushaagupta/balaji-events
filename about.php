    ...
    <!--about-->
      <div class="container">
        <div class="row" id="about">
          ...
          <div class="col s12 m12 l6 black" style="margin-top:20px;" id="abo_align">
            <h3 class="carddt center-align">About Us</h3>
            <p class="white-text">Balaji Events was made in 2017 as sub-organisation of 22 years old established travel company i.e. Balaji Travco India out of a passion for helping other people. We make the most important events in our clients’ lives and be as memorable and enjoyable as possible. Through strategic partnerships formed over the years, We have learned to be flexible and accommodating to each client’s unique needs and preferences. We hope you’ll let us plan your next unforgettable event. You won’t regret it.</p>
          </div>
          <div class="col s12 m12 l6">
               <img src="img/PicsArt_08-27-08.46.30.jpg" style="margin-top:20px;" class="responsive-img" alt="about balaji events i.e. event and wedding management company">
          </div>
        ...
        <div class="row">
            <div class="col s12 m12 l12 cardd" id="abo_align" style="margin-bottom: 20px;">
                <p class=" white-text">We are the Event and Wedding planners that think about need and budget of our clients and work accordingly.We take care of every possible thing like decor, food, stay and all our services are best and we always take care about the comfort of our client.</p>
            </div>
        </div>
      </div>
