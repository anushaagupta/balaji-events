...
?>
  ...
  <script type="text/javascript">
	...
	<!--heading-->
	 <div class="container">
      <p class="center-align white-text" style="margin-top: 50px; margin-bottom:50px;" >Complete Wedding planning is what makes the services of Balaji Events special. From engagement to reception, the team will coordinate and design each ceremony and party with perfection and according to your suggestions. The services offered by us include decor and design, catering, photography, anniversaries, entertainment and guest management.
      </p>
     </div>
      ...
      <div class="row">
        <div class="col s12 m12 l6">
           <a href="gallery.php">
            <img src="img/PicsArt_08-29-03.53.09.jpg" class="responsive-img one" width="100%" alt="wedding events travel stays" >
           </a>
         </div>
         ...
         <div class="col s12 m12 l6">
          <a href="gallery.php">
           <img src="img/PicsArt_08-29-03.47.01.jpg" class="responsive-img third" width="100%" alt="wedding events travel stays" >
          </a>
          </div>
      </div>
      ...
      <div class="row">
        <div class="col s12 m12 l6">
           <a href="gallery.php">
            <img src="img/PicsArt_08-29-03.25.16.jpg" class="responsive-img one" width="100%" alt="wedding events travel stays" >
           </a>
         </div>
         
         <div class="col s12 m12 l6">
          <a href="gallery.php">
           <img src="img/PicsArt_08-29-02.39.57.jpg" class="responsive-img third" width="100%" alt="wedding events travel stays" >
          </a>
          </div>
      </div>
      ...
      <div class="row">
        <div class="col s12 m12 l6">
           <a href="gallery.php">
            <img src="img/PicsArt_08-29-02.34.37.jpg" class="responsive-img one" width="100%" alt="wedding events travel stays" >
           </a>
         </div>
         
         <div class="col s12 m12 l6">
          <a href="gallery.php">
           <img src="img/PicsArt_08-29-03.49.59.jpg" class="responsive-img third" width="100%" alt="wedding events travel stays" >
          </a>
          </div>
      </div>
       ...
       <div class="row">
        <div class="col s12 m12 l6">
           <a href="gallery.php">
            <img src="img/PicsArt_08-29-02.49.59.jpg" class="responsive-img one" width="100%" alt="wedding events travel stays" >
           </a>
         </div>
         
         <div class="col s12 m12 l6">
          <a href="gallery.php">
           <img src="img/PicsArt_08-29-03.35.37.jpg" class="responsive-img third" width="100%" alt="wedding events travel stays" >
          </a>
          </div>
      </div>

     <div class="container cardd" style="margin-bottom: 60px">
       <p class="center-align white-text" style="padding: 40px 40px 40px 40px;">Balaji Events specialises in themed and destination weddings. It has extensive networks to find venue, vendors, and also experience and organisational abilities to plan any type of event across the social and religious spectrum. Be it a small beach wedding or a grand spectacular event with thousands of invitees, We will make them unforgettable, vibrant and beautiful.
      </p>
    </div>
